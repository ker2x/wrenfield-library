...
| 15 | `do-not-read-field-guide-to-timecrafting` | CR 1.1 / — 1483 | anonymous; "the author, who is not yet born" | **DO NOT READ**: A Field Guide to Timecrafting. The chapters are bound in the order of writing, which is neither the order of occurrence nor the order of reading; the safe reading order is at §0, placed last. A completed Form 7B arrived with it and is gone. The order must stay visibly, deliberately scrambled — the body runs §1, §7, §2, §11, §4, §9, §3, §12, §5, §8, §6, §10, §0, and the printed contents lists a *third* order. Cross-references inside entries point to the wrong neighbours on purpose ("see §12, which you have already read"). |
