...
| 07 | `non-existence-of-the-second-volume` | DP 44.9 / N66 1301 | attributed to N. Nott | **On the Non-Existence of the Second Volume** (1301). A divinatory proof that Vol. II was never written, in a library that lists it. Every volume in the library cites Vol. II. Shelf 44.9 is shorter than it should be. The *Cantor Minor* is given **no subject anywhere** — three parts, the first surviving and the third lost (§4.3's exception is entered in the margin) — and the attribution to **N. Nott** is an impossibility the Library records and does not resolve: the register of 1301 names the depositor, and Percival Nott was nineteen in 1461 and is in transit. **The impossibility stays an impossibility.** |
